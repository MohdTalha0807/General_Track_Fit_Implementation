...
{   
   ...
   const char *path="/home/mtalha/Ph.D._work/Triplet_fit_sim/Triplet_fit_wOnlyHitUnc/Method1/Fit_hitUncOnly";    //Triplet_MS_Fit";
   ofstream fout_1;
   fout_1.open ("/home/mtalha/Ph.D._work/Triplet_fit_sim/Triplet_fit_wOnlyHitUnc/Method1/Fit_hitUncOnly/triplet_sim_out_true12.txt");
   //fout_1<<"x"<<"\t"<<"\t"<<"y"<<"\t"<<"\t"<<"z"<<endl;       
