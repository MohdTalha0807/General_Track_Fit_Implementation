...
{   
   ...
   TH1D* h1 = new TH1D("h1", "Triplet MS Fit P3D = 20 GeV (constrained with hit uncertainties); p(fit) / p(gen); Entries;", 100, 0.0, 10.0);
   TH1D* h2 = new TH1D("h2", "Triplet MS Fit; sigma_{p}(fit) [MeV]; Entries;", 200, 50.0, 12000.0);
   TH1D* h3 = new TH1D("h3", "Triplet MS Fit (constrained with hit uncertainties); chi2_min_con; Entries;", 100, 0.0, 15.0);
   TH1D* h4 = new TH1D("h4", "Triplet MS Fit; (p(fit) - p(gen)) / sigma_{p}; Entries;", 100, -50.0, 50.0); 
