...
{   
   ...
   TH1D* h1 = new TH1D("h1", "Triplet MS Fit P3D = 20 GeV (unconstrained); p(fit) / p(gen); Entries;", 100, 0.8, 1.2);
   TH1D* h2 = new TH1D("h2", "Triplet MS Fit; sigma_{p}(fit) [MeV]; Entries;", 150, 600.0, 1200.0);
   TH1D* h3 = new TH1D("h3", "Triplet MS Fit (unconstrained); chi2_min_uncon; Entries;", 100, 0.0, 15.0);
